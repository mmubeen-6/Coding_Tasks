...
#     # while original implementation places the stride at the first 1x1
#     # convolution(self.conv1)
...
def resnet50(num_classes: int = 1000, **kwargs: Any):
    model = torchvision.models.resnet50(
        pretrained=torchvision.models.resnet.ResNet50_Weights.DEFAULT
    )
